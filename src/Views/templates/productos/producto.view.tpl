...
<section class="container-m row px-4 py-4">
    {{with product}}
    <form action="index.php?page=Productos_Producto&mode={{~mode}}&productId={{productId}}" method="POST"
        ...
        <div class="row my-2 align-center">
            ...
            <input class="col-12 col-m-9" {{~readonly}} type="text" name="productName" id="productName"
                placehoder="Nombre del Producto" value="{{productName}}" />
        ...
        <div class="row my-2 align-center">
            ...
            <input class="col-12 col-m-9" {{~readonly}} type="number" name="productPrice" id="productPrice"
                placehoder="" value="{{productPrice}}" />
        ...
        <div class="row my-2 align-center">
            ...
            <input class="col-12 col-m-9" {{~readonly}} type="text" name="productImgUrl" id="productImgUrl"
                placehoder="Nombre del Producto" value="{{productImgUrl}}" />
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        btnCancelar.addEventListener("click", (e) => {
            e.preventDefault();
            e.stopPropagation();
            window.location.assign("index.php?page=Productos_Productos");
        });
    });
</script>